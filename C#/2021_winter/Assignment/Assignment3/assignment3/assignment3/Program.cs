...
namespace assignment3
{
    ...
    class Time
    {
        ...
        // Methods
        public Time(int hours, int minute, int minutes=0){
            this.hours = hours;
            this.minutes = minute;
        }
        ...
        public static bool operator ==(Time lhs, Time rhs){
            int m = Math.Abs(lhs.minutes - rhs.minutes);
            int h = Math.Abs(lhs.hours - rhs.hours);
            int t = m + h * 60;
            if (t < 15)
                return true;
            return false;
    ...
    class Movie
    {
        ...
        Genre Genre;
        IList<string> Cast = new List<string>();
        public Genre getGenre() { 
            return Genre; 
        }
        public IList<string> getCast() { 
            return Cast; 
        }
    ...
    class Theatre
    {
        ...
        public void PrintShows(){
            foreach (var mv in show)
                Console.WriteLine(mv);
        }
        public void PrintShows(Genre genre){
            foreach (var mv in show){
                Movie m2 = mv.getMovie();
                Genre m = m2.getGenre();
                if (m == genre)
                    Console.WriteLine(mv);
            }
        ...
        public void PrintShows(string actor){
            ...
            {
                Movie m2 = mv.getMovie();
                IList<string> l = m2.getCast();
                foreach (string l1 in l){
                    if (l1 == actor)
                        Console.WriteLine(mv);
                }
            }
